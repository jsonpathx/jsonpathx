...
export type SegmentNode = RootNode | CurrentNode | ChildNode | RecursiveNode | FilterNode | ScriptNode | ParentNode | PropertyNameNode | TypeSelectorNode;
...
export type SelectorNode = WildcardSelector | IdentifierSelector | IndexSelector | SliceSelector | UnionSelector;
