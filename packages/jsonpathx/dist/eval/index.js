...
export function evaluateExpression(expression, context, root, policy) {
    ...
    const fn = new Function(...argNames, `"use strict"; return (${normalized});`);
    const argValues = [
        context.value,
        context.parent,
...
function enforceSandboxOnly(expression, sandbox) {
